        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                        <form  method="post" action="/post_hewan/{{ $hewan->slug }}" enctype="multipart/form-data">
                            @method('put')
                            @csrf
                            ...
                            <div class="form-group form-float  ">
                                <div class="form-line hidden">
                                    ...
                                    value="{{ $det->find(2)->id}}" readonly>
                                    
                                </div>
                            </div>
                            <div class="form-group form-float">
                                <div class="form-line @error('jenis') focused error @enderror">
                                    <input for="jenis" type="text" class="form-control" id="jenis" name="jenis" value="{{ old('jenis', $hewan->jenis) }}">
                                    <label class="form-label active">Jenis</label>
                                </div>
                            </div>
                            <div class="form-group form-float">
                                <div class="form-line ">
                                    <input for="slug" type="text" class="form-control" id="slug" name="slug"  readonly value="{{ old('slug', $hewan->slug) }}">
                                    <label class="form-label active"></label>
                                </div>
                            </div>
                            <div class="form-group form-float">
                                <div class="form-line @error('warna') focused error @enderror">
                                    <input for="warna" type="text" class="form-control" id="warna" name="warna" value="{{ old('warna', $hewan->warna) }}">
                            ...
                            <div class="form-group form-float">
                                <div class="form-line @error('contact') focused error @enderror">
                                    <input for="contact" type="text" class="form-control" id="contact" name="contact" value="{{ old('contact', $hewan->contact) }}">
                            ...
                            <div class="form-group form-float">
                                <div class="form-line @error('nama_kalung') focused error @enderror">
                                    <input for="nama_kalung" type="text" class="form-control" id="nama_kalung" name="nama_kalung"value="{{ old('nama_kalung', $hewan->nama_kalung) }}">
                            ...
                            <div class="form-group form-float">
                                <div class="form-line @error('last') focused error @enderror">
                                    <input for="last" type="text" class="form-control" id="last" name="last"value="{{ old('last', $hewan->last) }}">
                                    <label class="form-label">Terakhir Terlihat di..</label>
                                </div>
                            </div>
                            <div class="form-group form-float">
                                <div class="form-line @error('reward') focused error @enderror">
                                    <input for="reward" type="text" class="form-control" id="reward" name="reward"value="{{ old('reward', $hewan->reward) }}">
                            ...
                            <div class="form-group form-float">
                                <div class="form-line @error('spesial') focused error @enderror">
                                    <textarea for="spesial" name="spesial" id="spesial" cols="30" rows="5" class="form-control no-resize" >{{ old('spesial', $hewan->spesial) }}</textarea>
                            ...
                            <div class="form-group col-sm-6  ">
                                ...
                                <input type="hidden" name="oldImage" value="{{ $hewan->image }}">
                                @if ($hewan->image)
                                <img src="{{ asset('storage/' . $hewan->image ) }}"  class="img-fluid mb-2 col-sm-4 d-block">
                                @else                                   
