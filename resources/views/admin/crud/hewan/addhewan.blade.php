                    ...
                    <div class="body">
                            ...
                            <form  method="post" action="/post_hewan" enctype="multipart/form-data" >
                                ...
                                <div class="form-group col-sm-6  ">
                                    <label for="sertifikat" class="form-label">Sertifikat Kepemilikan Hewan</label>
                                    <input class="form-control  @error('sertifikat')
                                    is-invalid
                                    @enderror" type="file" id="sertifikat" name="sertifikat"  onchange="sertif()" required>
                                    <img class="img-sertif img-fluid mb-2 col-sm-4 ">
