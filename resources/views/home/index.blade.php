...
@section('home')
  ...
  <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
    <div class="container" data-aos="fade-in">
      <h1>Selamat datang di Finden</h1>
      <h2>Kami Menyediakan fasilitas untuk memudahkan anda Mencari dan menemukan <br>Kerabat atau Hewan Peliharaan Yang Hilang</h2>
      <h2></h2>
      <div class="d-flex align-items-center">
        <i class="bx bxs-right-arrow-alt get-started-icon"></i>
        <a href="#about" class="btn-get-started scrollto">Mulai Mencari</a>
      </div>
    </div>
  </section><!-- End Hero -->
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="200">
            <div class="member">
              <div class="member-img">
                <img src="44.jpg" class="img-fluid" alt="">
                <div class="social">
                  <a href=""><i class="bi bi-twitter"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
                  <a href=""><i class="bi bi-instagram"></i></a>
    ...
    <section id="contact" class="contact">
      <div class="container">
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-xl-3 col-lg-4 mt-4" data-aos="fade-up" data-aos-delay="100">
            <div class="info-box">
              ...
              <h3>Email</h3>
              <p>finden@gmail.com<br>kozumekenma257.com</p>
            </div>
          </div>
          <div class="col-xl-3 col-lg-4 mt-4" data-aos="fade-up" data-aos-delay="200">
            <div class="info-box">
              ...
              <h3>Telepom</h3>
              <p>+62 8515 6445 873<br>+1 6678 254445 41</p>
            </div>
          </div>
        </div>
        ...
        <div class="row justify-content-center" data-aos="fade-up">
          ...
          @endif
            <form action="{{ route('send.email') }}" method="post" class="ocid">
              @csrf
              <div class="row">
